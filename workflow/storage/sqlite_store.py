...
@safe_sync_call(logger=astrbot_logger, log_msg="kv_set failed")
...
@safe_sync_call(logger=astrbot_logger, log_msg="kv_delete failed")
...
@safe_sync_call(logger=astrbot_logger, log_msg="md_doc_set failed")
...
@safe_sync_call(logger=astrbot_logger, log_msg="seed_set_entry failed")
...
@safe_sync_call(
    logger=astrbot_logger,
    log_msg="image_labels_get_all failed",
    default_return={},
)
...
@safe_sync_call(logger=astrbot_logger, log_msg="image_label_upsert failed")
